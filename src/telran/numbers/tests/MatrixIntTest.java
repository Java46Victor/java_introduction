...
class MatrixIntTest {
	...
	void testRemoveColum() {
		...
		assertArrayEquals(expected, MatrixInt.removeColum(matrix1, 1));
		assertArrayEquals(expected, MatrixInt.removeColum(matrix2, 0));
		assertArrayEquals(expected, MatrixInt.removeColum(matrix3, 2));
	}
